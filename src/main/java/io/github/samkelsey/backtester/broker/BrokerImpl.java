 ...
 */
@Slf4j
public class BrokerImpl implements Broker, BrokerReader {
     ...
     * @return {@link BrokerImpl}
     */
    public BrokerImpl refreshBroker(StockData... stockData) {
